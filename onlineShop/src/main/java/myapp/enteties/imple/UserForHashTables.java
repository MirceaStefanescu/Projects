...
public class UserForHashTables implements User {
    ...
    public UserForHashTables(int id,
                             String firstName,
                             String lastName,
                             String password,
                             String email) {
    ...
    /*
    The class overrides the hashCode() and equals() methods, which are used for hashing and
    equality comparison, respectively. These methods ensure that user objects can be properly
    used in hash tables or other data structures that rely on hashing and equality checks.
     */
    ...
    @Override public String getCreditCard() {
        return this.creditCard;
    }

    @Override public void setCreditCard(String creditCard) {
