...
import myapp.services.ProductManagementService;
import myapp.storage.ProductStoringService;
import myapp.storage.impl.DefaultProductStoringService;
...
public class DefaultProductManagementService implements ProductManagementService {
    ...
    private static void initProducts() {
        products = new ArrayList<>(Arrays.asList(
                ...
                new DefaultProduct(5,
                                   "Worcester 2000 30kW Ng Combi Boiler Includes Free Comfort+ II" +
                                   " controller",
                                   "Boilers", 989.99),
                new DefaultProduct(6, "Glow-worm Betacom 4 30kW Combi Gas Boiler ERP", "Boilers",
                                   787.99), new DefaultProduct(7,
                                                               "Worcester 2000 25kW Ng Combi " +
                                                               "Boiler with Free Comfort+ II " +
                                                               "controller",
                                                               "Boilers", 859.99),
                new DefaultProduct(8,
                                   "Wienerberger Terca Class B Engineering Brick Red 215mm x 102" +
                                   ".5mm x 65mm (Pack of 504)",
                                   "Bricks", 402.99), new DefaultProduct(9,
                                                                         "Wienerberger Terca " +
                                                                         "Engineering Brick Blue " +
                                                                         "Perforated Class B 65mm" +
                                                                         " (Pack of 400)",
                                                                         "Bricks", 659.99),
                new DefaultProduct(10,
                                   "Wienerberger Engineering Brick Red Smooth Class B 73mm - Pack" +
                                   " of 368",
                                   "Bricks", 523.99)));
    }
    ...
    @Override public Product getProductById(int productIdToAddToCart) {
