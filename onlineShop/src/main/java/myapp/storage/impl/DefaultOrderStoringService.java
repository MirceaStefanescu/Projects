...
public class DefaultOrderStoringService implements OrderStoringService {
    ...
    @Override public void saveOrders(List<Order> orders) {
        try (var oos = new ObjectOutputStream(new FileOutputStream(
                RESOURCES_FOLDER + File.separator + CURRENT_TASK_RESOURCE_FOLDER + File.separator +
    ...
    @Override public List<Order> loadOrders() {
