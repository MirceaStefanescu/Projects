...
import myapp.services.imple.DefaultProductManagementService;
...
public class ProductCatalogMenu implements Menu {
        ...
        while (true) {
            ...
            if (userInput.equalsIgnoreCase(CHECKOUT_COMMAND)) {
                ...
                if (sessionCart == null || sessionCart.isEmpty()) {
                    System.out.println(
                            "Your cart is empty. Please, add product to cart first and then " +
                ...
                if (productToAddToCart == null) {
                    System.out.println(
                            "Please, enter product ID if you want to add product to cart. Or " +
                            "enter 'checkout' if you want to proceed with checkout. Or enter " +
    ...
    private String readUserInput() {
        System.out.print(
                "Product ID to add to cart or enter 'checkout' to proceed with checkout: ");
